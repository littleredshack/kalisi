 ...
 */
function flattenHierarchyWithEdges(hierarchyRoots) {
  const flatNodes = [];
  const containsEdges = [];
...
class ContainmentRuntimeLayoutEngine {
   ...
   */
  layoutFlatFromHierarchy(hierarchyRoots, metrics, config) {
    // Flatten hierarchy (but don't generate edges - they already exist in original data)
    const flatResult = (0,_helpers_flat_layout_helper__WEBPACK_IMPORTED_MODULE_3__.flattenHierarchyWithEdges)(hierarchyRoots);
